...
<br>
<div class="text-end">
    &nbsp; &nbsp; <a href="{{route('clientes.create')}}" class="btn btn-dark text-success"><b>Agregar Nuevo</b></a>
    &nbsp; &nbsp; &nbsp;
    <a href="{{url('clientes/mapa')}}" class="btn btn-dark text-success"><b>Ver Mapa Global</b></a>
</div>
<br>
<br>
    ...
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Crear, envia al formulario DELETE
