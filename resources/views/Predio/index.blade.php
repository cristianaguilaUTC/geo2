...
@section ('content')
    ...
    <a style="padding: 10px; background-color: black; color: green; border-radius: 5px; text-decoration-line: none;" href="{{ route('predios.create') }}"><i class="fa-solid fa-plus"></i> <b>Agregar nuevo predio</b></a> <br><br>
